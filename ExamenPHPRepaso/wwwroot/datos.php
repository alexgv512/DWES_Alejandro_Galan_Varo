    ...
    <body>
        ...
        $libros = [
            ...
            "9780987654321" => [
                ...
                "editorial" => "Innovación Editorial",
                "ano_edicion" => 2021,
                "autores" => [
                    ["nombre" => "Luis", "apellido1" => "Ramírez", "apellido2" => "Martínez"]
                ]
            ],
            "9781122334455" => [
                "unidades" => 8,
                ...
                "ano_edicion" => 2019,
                "autores" => [
                    ["nombre" => "Carla", "apellido1" => "Fernández", "apellido2" => "Gómez"],
                ]
            ],
            "9786677889900" => [
                "unidades" => 12,
                ...
                "ano_edicion" => 2022,
                "autores" => [
                    ["nombre" => "Ana", "apellido1" => "Mendoza", "apellido2" => "Cortés"]
                ]
            ]
        ];
       ...
       /* function escribeUsuario($usu){
            ...
            if(isset($usuarios[$usu])){
                $usua = $usuarios[$usu];
                echo $usua .["apellido1"] . $usua .["apellido1"].", " .$usua .["nombre"];
                echo "Esta con nosotros desde ". $usua .["fechaalta"];
            }else{
                echo"Usuarion no encontrado";
            }
        }*/
